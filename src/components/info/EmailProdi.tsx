...
import datakaprodi from "../../utils/emailKaprodi.json";
    ...
    <div>
      <div className="flex items-center gap-2">
        <Image
          ...
          height={25}
        />
        <span className="font-bold">Email Program Studi</span>
      </div>
      <div className="flex items-center justify-end">
        <div className="relative mt-2 rounded-md shadow-sm">
          ...
          <input
            ...
            placeholder="Cari Email / Nama Kaprodi..."
          />
        </div>
      </div>
            ...
            <tbody>
              {datakaprodi.map((data) => (
                <tr key={data.id} className="hover">
                  ...
                  <td>
                    <span className="text-[#0457A9] font-bold">
                      {data.email}
                    </span>
                  </td>
                </tr>
