    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        <Image
          ...
          height={25}
        />
        <span className="font-bold">Pembuatan Surat Pengantar Riset</span>
      </div>
      ...
      <div className="md:ml-8 mt-1">
        <p className="text-justify text-sm sm:text-md md:text-base">
          ...
          Pembuatan Surat Pengantar Riset Online, Segala aktifitas yang anda
          lakukan di Ruang Mahasiswa ini dicatat secara otomatis oleh Program,
          gunakan fasilitas ini dengan bijaksana.
        </p>
...
export default BuatPengantarRiset;
